...
def test_version_compare():
    ...
    assert QgsVersion.from_pluginversion('1.2') != QgsVersion.from_pluginversion('1.2.3')
    assert not QgsVersion.from_pluginversion('1.2') == QgsVersion.from_pluginversion('1.2.3')

    assert QgsVersion.from_pluginversion('1.2-3_4 5') == QgsVersion.from_pluginversion('1 2 3 4 5')
    assert not QgsVersion.from_pluginversion('1.2') == QgsVersion.from_pluginversion('1.3')
    ...
    assert not QgsVersion.from_pluginversion('1.3') <= QgsVersion.from_pluginversion('1.2')
    assert QgsVersion.from_pluginversion('1.3') >= QgsVersion.from_pluginversion('1.2')
    assert not QgsVersion.from_pluginversion('1.2') >= QgsVersion.from_pluginversion('1.3')
...
def test_version_original():
    ...
    assert QgsVersion.from_qgisversion('3.99.1', fix_plugin_compatibility = True).original == '3.99.1'
...
def test_version_prefix():
    ...
    assert QgsVersion.from_pluginversion('VER.1.2') == QgsVersion.from_pluginversion('1.2')
    assert QgsVersion.from_pluginversion('VERSION 1.2') == QgsVersion.from_pluginversion('1.2')
